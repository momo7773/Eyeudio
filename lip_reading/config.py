...
def load_args(default_config=None):
    ...
    # Data
    parser.add_argument('--data_path', type=str, default='lip_reading/media/', help='Path to the videos')
    parser.add_argument('--data_list', type=str, default='lip_reading/media/demo_list.txt', help='List of (video_path, transcription) entries. Video paths should be relative to --data_path')
    ...
    # Model
    parser.add_argument('--lip_model_path', type=str, default='lip_reading/models/lrs2_lip_model', help='Path to the trained model to evaluate')

    parser.add_argument('--graph_type', type=str, default='infer', help='Train or infer graph')
